...
// notifications
router.route("/notifications").get(verifyJWT_username, getNotifications);
router.route("/notifications/:notificationId/read").patch(verifyJWT_username, markNotificationRead);
router.route("/notification-settings").patch(verifyJWT_username, updateNotificationSettings);

// ratings
router.route("/rate").post(verifyJWT_username, rateUser);
router.route("/:username/ratings").get(verifyJWT_username, getUserRatings);
router.route("/analytics").get(verifyJWT_username, getUserAnalytics);
router.route("/recommendations").get(verifyJWT_username, getRecommendations);
