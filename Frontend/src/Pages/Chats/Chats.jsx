...
const Chats = () => {
  ...
  const handleChatClick = async (chatId) => {
    try {
      ...
      const { data } = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/message/getMessages/${chatId}`);
                      ...
                      >
                        ...
                        >
                          {message.messageType === 'file' ? (
                            <div>
                              <a href={message.file} target="_blank" rel="noopener noreferrer" style={{ color: "#ffffff" }}>
